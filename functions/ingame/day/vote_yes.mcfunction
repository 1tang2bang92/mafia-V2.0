...
execute if entity @s[tag=!voted] run tellraw @s ["",{"text":"You have voted "},{"text":"YES","color":"green"},{"text":" for ","color":"white"},{"selector":"@p[scores={candidate=1}]","color":"dark_red","bold":true}]
execute if entity @s[tag=!voted,tag=extra-vote] run tellraw @s ["\n\n\n",{"text":"You have one more vote.","color":"white","bold":false}]
execute if entity @s[tag=!voted,tag=!extra-vote] run tellraw @s ["\n\n\n",{"text":"Your voting has ended.","color":"white","bold":false}]
