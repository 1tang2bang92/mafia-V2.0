...
effect clear @s[scores={invisible=1}] minecraft:speed
effect clear @s[scores={invisible=1}] minecraft:regeneration
effect clear @s[scores={invisible=1}] minecraft:haste
