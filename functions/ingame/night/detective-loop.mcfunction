...
execute if score @s master matches 1..6 positioned ~ ~-1 ~ as @p[scores={job-detective=0},distance=..1,limit=1,sort=nearest] run function mafia:ingame/night/detective
