...
execute if entity @s[scores={job-soldier=5..}] run tellraw @s ["",{"text":"[Mafia V2.0]","color":"aqua","bold":true,"insertion":"/tellraw @p %s"},{"text":" 군인","color":"dark_green","bold":false},{"text":"의 생존기술로 기절상태를 벗어났습니다.","color":"gold"}]
