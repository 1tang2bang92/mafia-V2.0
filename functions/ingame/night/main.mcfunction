...
execute as @a[scores={job-reporter=1,rightC=1..},tag=!used-abil] at @s positioned ~ ~1.62 ~ run function mafia:ingame/night/reporter-loop
execute as @a[scores={job-robber=1,rightC=1..},tag=!used-abil] at @s positioned ~ ~1.62 ~ run function mafia:ingame/night/robber-loop
execute as @a[scores={job-detective=1,rightC=1..},tag=!used-abil] at @s positioned ~ ~1.62 ~ run function mafia:ingame/night/detective-loop
