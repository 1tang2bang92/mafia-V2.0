...
execute if score @s cool matches 0 if score @s master matches 0..6 positioned ~ ~-1 ~ as @p[scores={job-police=0},distance=..1,tag=player,sort=nearest,limit=1] run function mafia:ingame/night/police
